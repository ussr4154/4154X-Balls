#include "main.h"
#define CATA_AUTON_POSITION 8400
...
void skills(){
  ...
  EZchassis.set_drive_pid(-19, 80, true);
  EZchassis.wait_drive();
  ...
  EZchassis.set_drive_pid(-10.5, 120, true);
  EZchassis.wait_drive();
  ...
  EZchassis.set_turn_pid(214, 60);
  EZchassis.wait_drive();

  EZchassis.set_drive_pid(-16, 70, true);
  EZchassis.wait_drive();

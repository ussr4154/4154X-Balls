#include "main.h"
#define CATA_AUTON_POSITION 400
...
void skills(){
  ...
  EZchassis.set_drive_pid(59.5, 120, true);
  EZchassis.wait_drive();
  ...
  EZchassis.set_drive_pid(-33, 70, true);
  EZchassis.wait_drive();

  intake = 127;

  EZchassis.set_drive_pid(-31, 40, true);
  EZchassis.wait_drive();
  ...
  EZchassis.set_drive_pid(-35, 40, true);
  EZchassis.wait_drive();
